 ...
 *
 * This literal must match `REDUCER_RECEIPT_PREFIX` in `reducer/config.ts`.
 */
const EVIDENCE_REDUCER_RECEIPT_PREFIX = "sol_opencode_evidence_receipt_v1";

/** Harness-neutral shape of a candidate tool result. Adapters translate. */
