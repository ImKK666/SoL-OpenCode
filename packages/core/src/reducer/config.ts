...
export const REDUCER_EVENT_TYPE = "sol-opencode-evidence-preserving-reducer-v1" as const;
export const REDUCER_EVENT_SCHEMA = "sol-opencode-evidence-preserving-reducer/1" as const;
export const REDUCER_RECEIPT_SCHEMA = "sol-opencode-evidence-receipt/1" as const;
export const REDUCER_RECEIPT_PREFIX = "sol_opencode_evidence_receipt_v1" as const;
